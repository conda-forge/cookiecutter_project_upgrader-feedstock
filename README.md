About cookiecutter_project_upgrader-feedstock
=============================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cookiecutter_project_upgrader-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14198&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cookiecutter_project_upgrader-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cookiecutter_project_upgrader` can be installed with `conda`:
...
```
mamba install cookiecutter_project_upgrader
```

It is possible to list all of the versions of `cookiecutter_project_upgrader` available on your platform with `conda`:
...
```
mamba search cookiecutter_project_upgrader --channel conda-forge
```
...
mamba repoquery search cookiecutter_project_upgrader --channel conda-forge

# List packages depending on `cookiecutter_project_upgrader`:
mamba repoquery whoneeds cookiecutter_project_upgrader --channel conda-forge

# List dependencies of `cookiecutter_project_upgrader`:
mamba repoquery depends cookiecutter_project_upgrader --channel conda-forge
```
